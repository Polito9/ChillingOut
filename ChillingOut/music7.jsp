...
%>
    ...
    <div class="content">
        ...
        resultSet = statement.executeQuery("SELECT * FROM favoritos WHERE id_cancion = 7 AND username = '"+usuarioId+"';");
        ...
        %>
            ...
            Favorito
            <input type="hidden" id="cancion-id" value="7">
...
<script>
  ...
  function onYouTubeIframeAPIReady() {
    player = new YT.Player('player', {
      ...
      videoId: 'dBqyX0UUzVQ', // ID del video de YouTube
      playerVars: {
