...
%>
    ...
    <div class="content">
        ...
        resultSet = statement.executeQuery("SELECT * FROM favoritos WHERE id_cancion = 6 AND username = '"+usuarioId+"';");
        ...
        %>
            ...
            Favorito
            <input type="hidden" id="cancion-id" value="6">
...
<script>
  ...
  function onYouTubeIframeAPIReady() {
    player = new YT.Player('player', {
      ...
      videoId: 'G8Hq9UB8zB8', // ID del video de YouTube
      playerVars: {
