...
%>
    ...
    <div class="content">
        ...
        resultSet = statement.executeQuery("SELECT * FROM favoritos WHERE id_cancion = 4 AND username = '"+usuarioId+"';");
        ...
        %>
            ...
            Favorito
            <input type="hidden" id="cancion-id" value="4">
...
<script>
  ...
  function onYouTubeIframeAPIReady() {
    player = new YT.Player('player', {
      ...
      videoId: 'ulHO6WNw1Ts', // ID del video de YouTube
      playerVars: {
