...
%>
    ...
    <div class="content">
        ...
        resultSet = statement.executeQuery("SELECT * FROM favoritos WHERE id_cancion = 3 AND username = '"+usuarioId+"';");
        ...
        %>
            ...
            Favorito
            <input type="hidden" id="cancion-id" value="3">
...
<script>
  ...
  function onYouTubeIframeAPIReady() {
    player = new YT.Player('player', {
      ...
      videoId: 'bc0KhhjJP98', // ID del video de YouTube
      playerVars: {
