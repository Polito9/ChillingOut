  ...
  <% 
    ...
    try {
      ...
      while (resultSet.next()) {
        ...
        String autor = resultSet.getString("id_usuario");
        Date fecha = resultSet.getDate("fecha_public");

        // Generar el código HTML para mostrar cada publicación
        %>
      ...
      // Cerrar recursos y liberar la conexión a la base de datos
      if (resultSet != null) {
