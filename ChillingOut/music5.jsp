...
%>
    ...
    <div class="content">
        ...
        resultSet = statement.executeQuery("SELECT * FROM favoritos WHERE id_cancion = 5 AND username = '"+usuarioId+"';");
        ...
        %>
            ...
            Favorito
            <input type="hidden" id="cancion-id" value="5">
...
<script>
  ...
  function onYouTubeIframeAPIReady() {
    player = new YT.Player('player', {
      ...
      videoId: 'STugQ0X1NoI', // ID del video de YouTube
      playerVars: {
